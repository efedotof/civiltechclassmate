...
class ShowBottomBarsReplace {
  final Tasks task;
  final int indexs;
  ShowBottomBarsReplace(BuildContext context, {required this.task, required this.indexs});
  ...
  void showBottomModal(BuildContext context) {
    ...
    List<String> fileString = task.file.split(',');
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: OutlinedButton(
                              ...
                              onPressed: () {
                                tasksBox.deleteAt(indexs);
                                complitedBox.add(Complited(heading: task.heading, description: task.description, file: task.file, subject: task.subject));
